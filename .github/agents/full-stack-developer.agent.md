...
```bash
# Backend AI Server (FastAPI/Python)
cd backendai/
...
# Chatbot SDK (TypeScript/React)
cd rhinonbot-sdk/
npm install
npm run dev  # Development mode with webpack
npm run build  # Build for production (@rhinon/botsdk)
```
...
# Database
POSTGRES_HOST=rhinonserver.cxy04gkg4y23.ap-south-1.rds.amazonaws.com
POSTGRES_PORT=5432
POSTGRES_DB=rt-database
POSTGRES_USER=postgres
POSTGRES_PASSWORD=<password>

# MongoDB (Gemini chat history)
MONGO_URI=mongodb+srv://cluster0.btx9drd.mongodb.net/chatbot
```
...
### rhinonbot-sdk/.env
```bash
REACT_APP_NEW_SERVER_API_URL=http://localhost:3000
REACT_APP_API_URL_AI=http://localhost:5002
...
fix(tickets): resolve pagination bug
docs(readme): update setup instructions
```

---

**Platform**: Rhinon Tech - All-in-one Customer Engagement Platform  
**Tech Stack**: FastAPI + Next.js 16 + Express.js + PostgreSQL + Socket.IO + AWS  
**Version**: 2.0
